        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="col-lg-6 d-none d-lg-block">
              <img src="img/escom.jpg" width="400" height="500">
            </div>
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form action="logic_php/log.php" method="POST" class="user">
                    <div class="form-group">
                      <input type="number" class="form-control form-control-user" id="boleta" name="boleta" aria-describedby="emailHelp" placeholder="Número de boleta">
                    </div>
                    <div class="form-group">
